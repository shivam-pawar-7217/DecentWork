  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <>
                ...
                >
                  ...
                  <div className="flex flex-shrink-0 items-center px-4">
                    <span className="text-xl font-bold">DecentFreelance</span>
                  </div>
      ...
      <div className="flex flex-1 flex-col lg:pl-64">
        <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-background/80 backdrop-blur-sm border-b">
